    ...
    <div className={style.user}>
      ...
      <div className={style.games}>
        ...
        <p style={{ color: "white", textAlign: "center", fontSize: "1rem" }}>
          *Recuerda que solo puedes cancelar con un día de anticipación.
        </p>
                  ...
                  {showAlertCancel && (
                    <div className={style.popup}>
                      <div className={style.container}>
                        ...
                        <p>
                          Recuerda que puedes cancelar tu reserva hasta el día
                          anterior al turno
                        </p>
                        <p style={{ fontSize: "1.5rem" }}>
                          ⚠︎ ¿Esta seguro de eliminar esta reserva? ⚠︎{" "}
                        </p>
                      </div>
                      <div
                      ...
                      >
                        <button
                          ...
                          onClick={() => handleDelete(emailInfo)}
                        >
                          Eliminar
                        </button>
                        <button
