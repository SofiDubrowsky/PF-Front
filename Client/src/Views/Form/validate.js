const validate=(form)=>{
    ...
    // if(form.picture.length<1)errors.picture="Debe subir al menos 1 foto";
    if(!form.cost || form.cost===0 || !/^[0-9]+$/.test(form.cost))errors.cost="Debe proporcionarse un precio valido";
